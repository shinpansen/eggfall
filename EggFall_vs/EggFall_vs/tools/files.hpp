...
public:
    ...
    //Resources textures
	static const string wizardTextureA;
	static const string wizardTextureB;
	static const string wizardTextureC;
	static const string wizardTextureD;
	static const string wizardTextureE;
	...
	static const string hitEffectTile;
	static const string shieldEffectTile;
	static const string grindEffectTile;
	static const string dustEffectTile;
	static const string trees;
	static const string streetLamp;
	...
	static const string lifeStamina;
